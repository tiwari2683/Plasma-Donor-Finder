...
import { FaTimes, FaTachometerAlt, FaUser, FaSignOutAlt } from 'react-icons/fa';

function DonorSidebar({ isOpen, onClose }) {
  ...
  const navItems = [
    { label: 'Dashboard', icon: <FaTachometerAlt />, path: '/donor/dashboard' },
    { label: 'Profile', icon: <FaUser />, path: '/profile' },
  ];

  // Improved highlighting logic
  const isActive = (path) => {
    if (path === '/donor/dashboard') {
    ...
    <>
      ...
      `}>
        ...
        <div className="pt-8 lg:pt-0">
          <h2 className="text-xl sm:text-2xl font-bold mb-6 text-center text-white">Plasma Donor</h2>
